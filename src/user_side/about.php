...
<div class="container-fluid container-xl d-flex align-items-center justify-content-between">
  ...
  <!-- ======= Hero Section ======= -->
  <section id="" class="hero4">
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h3 style="color: white; font-weight: bold;">ABOUT PROJECT</h3><br><h2 style="font-size: 150px;">CURMA</span></h2>
          <p>Coastal Underwater Resource Management Actions</p>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#about" class="btn-get-started">LEARN MORE</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="../assets/img/main_page/about.svg" class="img-fluid" alt="" data-aos="zoom-out"
            data-aos-delay="100">
        </div>
      </div>
    </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img src="../assets/img/main_page/profile_icon.png" class="img-fluid" alt="">
              <h4>JUAN A. DELA CRUZ</h4>
              <span style="font-weight: bolder;">Program Director</span>
              <br>
              <span style="text-align: justify;">He is the Project Director  of CURMA,  which works to protect sea  turtles and  their habitats through conservation travel and educational programs</span>
              <div class="social">
