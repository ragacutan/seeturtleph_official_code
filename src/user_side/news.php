            ...
            <div class="row gy-5" data-aos="fade-in">
                <div
                    ...
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="#recent-posts" class="btn-get-started">SEE ALL NEWS & UPDATE</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2">
                    <img src="../assets/img/main_page/news.svg" class="img-fluid" alt="" data-aos="zoom-out"
                        data-aos-delay="100">
                </div>
            </div>
        </div>
    ...
    <section id="recent-posts" class="recent-posts sections-bg" style="background-color:#E5F9FA;">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h1 style="text-align:left; font-weight: 900; text-decoration: none;">Latest News and Updates</h1>
            </div>
