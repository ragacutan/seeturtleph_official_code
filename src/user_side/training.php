    ...
    <div class="container position-relative">
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          <h2>TRAININGS AND
            SEMINARS</span></h2>
          <p>One of the most significant benefits of training and seminars on turtle
            Conservation is that it helps to increase awareness and understanding of
            the importance of turtles in the ecosystem. Furthermore, training and
            seminars on turtle conservation are essential for equipping researchers
            and conservationists with the knowledge and tools they need to study
            and protect turtle populations effectively. </span>
          </p>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#recent-posts" class="btn-get-started">SEE ALL TRAININGS & SEMINARS</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2">
          <img src="../assets/img/main_page/training.svg" class="img-fluid" alt="" data-aos="zoom-out"
            data-aos-delay="100">
        </div>
      </div>
    </div>
  ...
  <section id="recent-posts" class="recent-posts sections-bg" style="background-color:#E5F9FA;">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-header">
        <h1 style="text-align:left; font-weight: 900; text-decoration: none;">Trainings and Seminars</h1>
      </div>
