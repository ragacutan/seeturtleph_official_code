        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                <div
                    ...
                    <p>Volunteers can help with the management of turtle hatcheries, which
                        involves collecting eggs, caring for hatchlings, and releasing them into
                        the ocean. You can assist in monitoring turtle nests on the beach, identifying
                        potential threats to nests such as predators or human disturbance, and
                        marking the nests to protect them. You can participate in educational and
                        outreach activities to raise awareness about turtle conservation and its
                        importance. </span>
                    </p>
                    <div class="d-flex justify-content-center justify-content-lg-start">
                        <a href="#recent-posts" class="btn-get-started">SEE ALL VOLUNTEER OPPORTUNITIES</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2">
                    <img src="../assets/img/main_page/volunteer.svg" class="img-fluid" alt="" data-aos="zoom-out"
                        data-aos-delay="100">
                </div>
            </div>
        </div>
    ...
    <section id="recent-posts" class="recent-posts sections-bg" style="background-color:#E5F9FA;">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-header">
                <h1 style="text-align:left; font-weight: 900; text-decoration: none;">Upcoming Volunteer Programs</h1>
            </div>
                    ...
                    <?php foreach ($material as $row) { ?>
                        <div class="col-xl-4 col-md-6">
                            <article>
                                ...
                                <h2 class="title">
                                    <a href="view-material.php?id=<?= $row['material_id'] ?>">
                                        <?= display_material_preview($row['title'], 50) . '...' ?>
                                    </a>
                                </h2>
                                <p class="post-author" style="color: red;">
                                    Schedule:
                                        <?= $row['date'] ?> || <?= $row['time'] ?>
                                </p>
