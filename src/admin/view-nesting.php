...
<body>
    ...
    <div class="left-side-bar">
        <div class="brand-logo">
            <a href="index.html">
                <img src="src\images\see-logo-white-2.pnggo.png" alt="" class="dark-logo">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>View Marine Turtle Nest Evaluation</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">View Marine Turtle Nest Evaluation</li>
                                </ol>
                            </nav>
                        </div>
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <form method="post" class="myForm" autocomplete="off">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" id="location_nest" name="location_nest"
                                    value="<?php echo $row2['location_nest']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Lattitude:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="latitude" id="latitude"
                                    value="<?php echo $row2['latitude']; ?>" placeholder="Latitude..." readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                ...
                                <input class="form-control" name="longitude" id="longitude"
                                    value="<?php echo $row2['longitude']; ?>" placeholder="longitude..." readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="new_location" id="new_location"
                                    value="<?php echo $row2['new_location']; ?>" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="number_transplanted" id="number_transplanted"
                                    value="<?php echo $row2['number_transplanted']; ?>" type="text" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control date-picker" name="date_transplanted" id="date_transplanted"
                                    value="<?php echo $row2['date_transplanted']; ?>" type="text" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_egg_hatched" id="no_egg_hatched"
                                    value="<?php echo $row2['no_egg_hatched']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_egg_unhatched" id="no_egg_unhatched"
                                    value="<?php echo $row2['no_egg_unhatched']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_unhatched_fertile" id="no_unhatched_fertile"
                                    value="<?php echo $row2['no_unhatched_fertile']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="live_piped_eggs" id="live_piped_eggs"
                                    value="<?php echo $row2['live_piped_eggs']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="dead_piped_eggs" id="dead_piped_eggs"
                                    value="<?php echo $row2['dead_piped_eggs']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="without_visible_development"
                                    ...
                                    value="<?php echo $row2['without_visible_development']; ?>" placeholder="" type="number" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="predated" id="predated"
                                    value="<?php echo $row2['predated']; ?>" placeholder="" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="hatchling_dead_nest"
                                    id="hatching_dead_nest" value="<?php echo $row2['hatchling_dead_nest']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="hatchling_live_nest"
                                    id="hatchling_live_nest" value="<?php echo $row2['hatchling_live_nest']; ?>" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="text" name="turtle_id"
                                    id="turtle_id" value="<?php echo $row2['turtle_id']; ?>" readonly>
                            </div>
                        </div>
                        <a href="nest-record.php"><input type="button"  class="btn btn-primary btn-lg" name="submit" value="GO BACK" /></a>
                        <a href="update_nesting_record.php?id=<?php echo $id; ?>" class="btn btn-secondary btn-lg">UPDATE</a>
                </div>
                </form>
                <!-- js -->
