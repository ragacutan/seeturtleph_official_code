...
if(isset($_GET['id'])){
    ...
    $select2="SELECT FROM nesting_data WHERE id = $id";
    $result2 = mysqli_query($connection, "SELECT * FROM nesting_data WHERE id = $id");
...
if($_POST['submit']){
    $id = $_GET['id'];
    $location_nest = $_POST['location_nest'];
    $clutch_size = $_POST['clutch_size'];
    $new_location = $_POST['new_location'];
    $number_transplanted = $_POST['number_transplanted'];
    $date_transplanted = $_POST['date_transplanted'];
    $date_1 =$_POST['date_1'];
    $time_1 =$_POST['time_1'];
    $no_hatchling_1 = $_POST['no_hatchling_1'];
    $collected_by_1 = $_POST['collected_by_1'];
    $date_2 =$_POST['date_2'];
    $time_2 =$_POST['time_2'];
    $no_hatchling_2 = $_POST['no_hatchling_2'];
    $collected_by_2 = $_POST['collected_by_2'];
    $date_3 =$_POST['date_3'];
    $time_3 =$_POST['time_3'];
    $no_hatchling_3 = $_POST['no_hatchling_3'];
    $collected_by_3 = $_POST['collected_by_3'];
    $date_4 =$_POST['date_4'];
    $time_4 =$_POST['time_4'];
    $no_hatchling_4 = $_POST['no_hatchling_4'];
    $collected_by_4 = $_POST['collected_by_4'];
    $no_egg_hatched = $_POST['no_egg_hatched'];
    $no_egg_unhatched = $_POST['no_egg_unhatched'];
    $no_unhatched_fertile = $_POST['no_unhatched_fertile'];
    $live_piped_eggs = $_POST['live_piped_eggs'];
    $dead_piped_eggs = $_POST['dead_piped_eggs'];
    $without_visible_development = $_POST['without_visible_development'];
    $predated = $_POST['predated'];
    $hatchling_dead_nest = $_POST['hatchling_dead_nest'];
    $hatchling_live_nest = $_POST['hatchling_live_nest'];
    $turtle_id = $_POST['turtle_id'];
    
    $query = "UPDATE `nesting_data` SET `location_nest` = '$location_nest', `clutch_size` = '$clutch_size', `new_location` = '$new_location', `number_transplanted` = '$number_transplanted', `date_transplanted` = '$date_transplanted', `date_1` = '$date_1', `time_1` = '$time_1', `no_hatchling_1` = '$no_hatchling_1',
     `collected_by_1` = '$collected_by_1', `date_2` = '$date_2', `time_2` = '$time_2', `no_hatchling_2` = '$no_hatchling_2', `collected_by_2` = '$collected_by_2', `date_3` = '$date_3', `time_3` = '$time_3', `no_hatchling_3` = '$no_hatchling_3', `collected_by_3` = '$collected_by_3', 
     `date_3` = '$date_3', `time_3` = '$time_3', `no_hatchling_3` = '$no_hatchling_3', `collected_by_3` = '$collected_by_3', `date_4` = '$date_4', `time_4` = '$time_4', `no_hatchling_4` = '$no_hatchling_4', `collected_by_4` = '$collected_by_4',
     `no_egg_hatched` = '$no_egg_hatched', `no_egg_unhatched` = '$no_egg_unhatched', `no_unhatched_fertile` = '$no_unhatched_fertile', `live_piped_eggs` = '$live_piped_eggs', `dead_piped_eggs` = '$dead_piped_eggs', `without_visible_development` = '$without_visible_development',
     `predated` = '$predated', `hatchling_dead_nest` = '$hatchling_dead_nest', `hatchling_live_nest` = '$hatchling_live_nest', `turtle_id` = '$turtle_id'  WHERE `id` = '$id' ";
        if (mysqli_query($connection, $query)) {
            header("Location: view-nesting.php?id={$_GET['id']}");
        } else {
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Update Marine Turtle Nest Evaluation</h4>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" id="location_nest" name="location_nest"
                                    value="<?php echo $row2['location_nest']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Clutch Size if Known:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="clutch_size" id="clutch_size"
                                    value="<?php echo $row2['clutch_size']; ?>"
                                    type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="new_location" id="new_location"
                                    value="<?php echo $row2['new_location']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="number_transplanted" id="number_transplanted"
                                    value="<?php echo $row2['number_transplanted']; ?>" type="text">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control date-picker" name="date_transplanted" id="date_transplanted"
                                    value="<?php echo $row2['date_transplanted']; ?>" type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_egg_hatched" id="no_egg_hatched"
                                    value="<?php echo $row2['no_egg_hatched']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">(UHT) Unhatched Full Embryo:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_egg_unhatched" id="no_egg_unhatched"
                                    value="<?php echo $row2['no_egg_unhatched']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="no_unhatched_fertile" id="no_unhatched_fertile"
                                    value="<?php echo $row2['no_unhatched_fertile']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">(LPE) Live Piped Eggs:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="live_piped_eggs" id="live_piped_eggs"
                                    value="<?php echo $row2['live_piped_eggs']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">(DPE) Dead Piped Eggs:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="dead_piped_eggs" id="dead_piped_eggs"
                                    value="<?php echo $row2['dead_piped_eggs']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">(UD) Eggs Without Visible
                                Development:</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" type="number" name="without_visible_development"
                                    id="without_visible_development"
                                    value="<?php echo $row2['without_visible_development']; ?>" placeholder="" type="number">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="predated" id="predated"
                                    value="<?php echo $row2['predated']; ?>" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="hatchling_dead_nest"
                                    id="hatching_dead_nest" value="<?php echo $row2['hatchling_dead_nest']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="number" name="hatchling_live_nest"
                                    id="hatchling_live_nest" value="<?php echo $row2['hatchling_live_nest']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Turtle ID (type unknown if not applicable):</label>
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" placeholder="" type="text" name="turtle_id"
                                    id="turtle_id" value="<?php echo $row2['turtle_id']; ?>">
                            </div>
                        </div>
                        <input type="submit"  class="btn btn-primary btn-lg" name="submit" value="SAVE" /></a>
                </div>
                </form>
                <!-- js -->
